import { z } from "zod";
import { passwordRegExp, emailRegExp, nicknameRegExp, } from "../constants/regularExpressions.js";
const registerSchema = z.object({
    ...
    nickname: z
        ...
        .regex(nicknameRegExp, "Nickname must be 3 to 24 characters long and can only contain letters, numbers, and underscores"),
    token: z
